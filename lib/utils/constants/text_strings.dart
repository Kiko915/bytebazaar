...
class BTexts {
  ...
  static const String appName = "ByteBazaar";
  static const String tContinue = "Continue";


  // -- OnBoarding Texts
  static const String onBoardingTitle1 = "BUY QUALITY PRODUCTS";
  static const String onBoardingTitle2 = "GET PRODUCTS FASTER";
  static const String onBoardingTitle3 = "BUILD YOUR OWN BUSINESS";
  static const String onBoardingTitle4 = "GET STARTED NOW!";

  static const String onBoardingSubTitle1 = "ByteBazaar is a leading multi-business platform that enables user to access and enjoy numerous products in their best quality.";
  ...
  static const String logIn = "Sign In"; // Used for the link text
  static const String firstName = "First Name"; // Keep if needed for other parts
